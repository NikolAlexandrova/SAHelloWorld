...
<div class="container-fluid gallery pb-5">
    <div class="container pb-5">
        <div class="pb-5">
            <h4 class="text-primary sub-title fw-bold wow fadeInUp" data-wow-delay="0.1s">Activities Gallery</h4>
            <h1 class="display-2 mb-0 wow fadeInUp white" data-wow-delay="0.3s">Our Activities gallery</h1>
        </div>
