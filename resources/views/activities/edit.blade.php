...
<div class="container-fluid events py-5">
    <div class="container py-5">
        <div class="pb-5">
            <form class ="form-control" action="{{ route('activities.update', $activity) }}" method="POST">
                @csrf
                @method('PATCH')
                <h2 class="text-primary sub-title fw-bold wow fadeInUp">Edit the activity</h2>
                <br>
                ...
                <div class="form-group">
                    ...
                    <div class="control has-icons-right">
                        <input type="text" name="title" placeholder="Enter the title..."
                               ...
                               value="{{ old('title', $activity) }}" autocomplete="title">
                        @error('title')
                ...
                <div class="form-group">
                    ...
                    <div class="control has-icons-right">
                                <textarea type="text" name="summary" placeholder="Enter the summary..."
                                          ...
                                          value="{{ old('summary', $activity) }}" autocomplete="summary" rows="5"></textarea>
                        @error('summary')
                        <span class="icon has-text-danger is-small is-right">
                                        <i class="fas fa-exclamation-triangle"></i>
                                </span>
                ...
                <div class="form-group">
                    ...
                    <div class="control has-icons-right">
                                <textarea type="text" name="description" placeholder="Enter the description..."
                                          ...
                                          value="{{ old('description', $activity) }}" autocomplete="description" rows="10"></textarea>
                        @error('description')
                        <span class="icon has-text-danger is-small is-right">
                                        <i class="fas fa-exclamation-triangle"></i>
                                </span>
                ...
                <div class="form-group">
                    ...
                    <div class="control has-icons-right">
                        <input type="text" name="location" placeholder="Enter the location..."
                               ...
                               value="{{ old('location', $activity) }}" autocomplete="location">
                        @error('location')
                        <span class="icon has-text-danger is-small is-right">
                                        <i class="fas fa-exclamation-triangle"></i>
                                </span>
                ...
                <div class="form-group">
                    ...
                    <div class="control has-icons-right">
                        <input type="number" name="allowed_participants" placeholder="Enter the number of allowed participants..."
                               ...
                               value="{{ old('allowed_participants', $activity) }}" autocomplete="allowed_participants">
                ...
                <div class="form-group">
                    ...
                    <div class="control has-icons-right">
                        <input type="time" name="starting_time" placeholder="Enter the starting time..."
                               ...
                               value="{{ old('starting_time', $activity) }}" autocomplete="starting_time">
                        @error('starting_time')
                        <span class="icon has-text-danger is-small is-right">
                                        <i class="fas fa-exclamation-triangle"></i>
                                </span>
                ...
                <div class="form-group">
                    ...
                    <div class="control has-icons-right">
                        <input type="time" name="ending_time" placeholder="Enter the ending time..."
                               ...
                               value="{{ old('ending_time', $activity) }}" autocomplete="ending_time">
                        @error('ending_time')
                        <span class="icon has-text-danger is-small is-right">
                                    <i class="fas fa-exclamation-triangle"></i>
                            </span>
                ...
                <div class="form-group">
                    ...
                    <div class="control has-icons-right">
                        <input type="date" name="date" placeholder="Enter the date..."
                               ...
                               value="{{ old('date', $activity) }}" autocomplete="date">
                        @error('date')
                        <span class="icon has-text-danger is-small is-right">
                                        <i class="fas fa-exclamation-triangle"></i>
                                </span>
                ...
                <div class="form-group">
                    ...
                    <div class="control has-icons-right">
                        <input type="number" name="amount" placeholder="Enter the price..."
                               ...
                               value="{{ old('amount', $activity) }}" autocomplete="amount">
                        @error('amount')
                        <span class="icon has-text-danger is-small is-right">
                            <i class="fas fa-exclamation-triangle"></i>
                         </span>
                ...
                <div class="form-group">
                    ...
                    <div class="control has-icons-right">
                        <input type="number" name="discounted_amount" placeholder="Enter the discounted price..."
                               ...
                               value="{{ old('discounted_amount', $activity) }}" autocomplete="discounted_amount">
                ...
                <div class="btn-group">
                    ...
                    <div class="control">
                        <a type="button" href="{{ route('dashboard', $activity) }}" class="btn btn-danger">Cancel</a>
                    </div>
                    <div class="control">
