        ...
        <div class="container py-5">
            <div class="row g-5 align-items-center">
                ...
                <div class="col-lg-7 wow fadeInRight" data-wow-delay="0.3s">
                    <h4 class="text-primary sub-title fw-bold">about The SA Hello World</h4>
                    <h1 class="display-3 mb-4 white"><strong class="text-secondary">SA Hello World</strong>, We have been organising events since 2024</h1>
        ...
        <div class="container py-5">
            ...
            <div class="team-carousel owl-carousel pt-5 wow fadeInUp" data-wow-delay="0.1s">
                ...
                <div class="team-item border rounded wow fadeInUp" data-wow-delay="0.3s">
                    ...
                    <div class="team-content text-center p-4">
                        <a href="#" class="h4">Ben Ten</a>
                        <p class="mb-0 text-primary">Event Manager</p>
                    </div>
                </div>
